...
MI_coevolutoin_path = input_root_folder + \
    "onePhylumRandomised_coevolutoin_result_MI/"
...
ArgForDCA = [
    (p1, p2, fasta_protein_lens[p1], fasta_protein_lens[p2], onePhylumRandomised_SamePosandNeg_pairedMSA_Nf90_folder, DCA_coevolutoin_path) for p1, p2 in input_PPs if (p1, p2) not in existed_pydcaFNAPC_pp_dict]
